...
function testTetrisRequirements() {
    ...
    const tests = [
        ...
        { name: 'Next piece variable', test: () => content.includes('nextPiece') },
        { name: 'Next piece draw function', test: () => content.includes('drawNextPiece') },
        { name: 'Next piece panel UI', test: () => content.includes('next-piece-panel') && content.includes('NEXT') },
        { name: 'Next piece queue logic', test: () => content.includes('createRandomPiece') }
    ];
